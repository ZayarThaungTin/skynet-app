...
const PremierScreen = ({ navigation, route }) => {
    ...
    const Payment_method_modal = () => {
        return <Center>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Modal.Content maxWidth="350">
                            <Modal.CloseButton />
                            <Modal.Header>Sky Premier Service</Modal.Header>
                            <Modal.Body>
            ...
            <Modal transparent={true} isOpen={showModal3} size="lg" onClose={() => setShowModal3(false)}>
                <View style={{
                    flex: 1,
                    flexDirection: 'column',
                    justifyContent: 'center',
                    ...
                    <View style={{
                        ...
                        <Modal.Content maxWidth="350">
                            ...
                            <Modal.Body>
                                <Radio.Group defaultValue="payment_1" name="payment_method" size="sm">
                                    <VStack space={7}>
                                        <Radio alignItems="flex-start" _text={{
                                            mt: "-1",
                                            ml: "2",
